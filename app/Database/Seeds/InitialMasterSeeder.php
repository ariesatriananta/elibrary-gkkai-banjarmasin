...
class InitialMasterSeeder extends Seeder
{
    public function run()
    {
        ...
        $this->db->table('settings')->insertBatch([
            ...
            [
                'setting_key' => 'late_fine_per_week',
                'setting_value' => '5000',
                'value_type' => 'number',
                'label' => 'Denda Keterlambatan per Minggu',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
                'setting_key' => 'late_grace_days',
                'setting_value' => '3',
                'value_type' => 'number',
                'label' => 'Masa Tenggang Keterlambatan (hari)',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
                'setting_key' => 'damage_fine_amount',
                'setting_value' => '100000',
                'value_type' => 'number',
                'label' => 'Denda Kerusakan Buku',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
